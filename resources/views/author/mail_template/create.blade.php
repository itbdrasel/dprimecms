			...
			<div class="card-body">
				...
				<div class="col-md-11">
						...
						<div class="form-group row">
							<label for="" class="col-sm-2 col-form-label">Name <code>*</code></label>
							<div class="col-sm-5">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<textarea name="template" cols="40" class="form-control editor" spellcheck="false">{{getValue('template', $objData)}}</textarea>
						</div>
					</div>

						<div class="form-group row">
							<label class="col-sm-2 col-form-label">Status <code>*</code></label>
							<div class="col-sm-5">
								<?php
