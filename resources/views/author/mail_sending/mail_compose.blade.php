...
@section("content")
    ...
    <section class="content">
        <!-- Default box -->
		<form method="post" action="{{url($bUrl.'/send-email')}}" enctype="multipart/form-data" >
			@csrf
		<div class="card">
			...
			<div class="card-body">
				...
				<div class="col-md-11">
					...
					<div class="form-group row">
						...
						<div class="col-sm-5">
							<input type="email" id="email" value="{{getValue('email', $objData)}}" name="email" class="form-control">
						</div>
