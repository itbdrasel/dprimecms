		...
		<div class="col-md-12 mt-4">
			...
			<table class="table table-bordered">
                ...
                <tr>
                    ...
                    <th class="sort text-center" data-row="status" id="status" >Status</th>					
                    <th class="sort text-left" data-row="email" id="email" >E-mail</th>
                    <th>Score</th>
                    <th>Unsubscribed</th>
                    <th>Validate</th>
				...
				@foreach ($allData as $data)
                    ...
                    if ($data->n_status == 1) {
                        $status = '<span class="badge badge-primary"><i class="fa fa-check-circle" aria-hidden="true" style="font-size:11px"></i> Verified</span>';
                    }elseif ($data->n_status == 2) {
                        $status = '<span class="badge badge-success"><i class="fa fa-check-circle" aria-hidden="true" style="font-size:11px"></i> Whitelist</span>';
                    }
                    @endphp
                    <tr>
                        ...
                        @endphp
                        <td><span class="badge badge-{{$data->n_validate==1?'success':'warning'}}">{{ $validateArray[$data->n_validate] }}</span></td>
